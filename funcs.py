...
def insert_one(post):
    # Connect to MongoDB
    client = MongoClient('mongodb+srv://xxxxxxxxxxxxxxxxxxxxxxxx/')
...
def read_documents(query={}):
    client = MongoClient('mongodb+srv://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/')
...
def update_document(document_id, update_values):
    ...
    client = MongoClient('mongodb+srv://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/')
